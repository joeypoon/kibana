...
export const AGENT_BUILDER_BUILTIN_TOOLS: string[] = [
  ...
  `${internalNamespaces.security}.automatic_troubleshooting.get_data`,
  `${internalNamespaces.security}.automatic_troubleshooting.get_context`,
...
export const AGENT_BUILDER_BUILTIN_AGENTS: string[] = [
  ...
  `${internalNamespaces.security}.automatic_troubleshooting`,
];
