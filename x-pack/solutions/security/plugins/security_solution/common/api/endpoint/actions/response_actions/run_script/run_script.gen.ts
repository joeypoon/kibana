...
export const EndpointRunScriptParameters = lazySchema(() =>
  z.object({
     ...
     */
    scriptInput: z.string().min(1).max(4096).optional(),
  })
);
...
export const RawScriptParameters = lazySchema(() =>
  z.object({
     ...
     * Raw script content.
     */
    raw: z.string().min(1).max(100000),
    /**
     * Command line arguments.
     */
    commandLine: z.string().min(1).max(30000).optional(),
    /**
     * Timeout in seconds.
     */
...
export const MDERunScriptParameters = lazySchema(() =>
  z.object({
     ...
     */
    args: z.string().min(1).max(4096).optional(),
  })
);
