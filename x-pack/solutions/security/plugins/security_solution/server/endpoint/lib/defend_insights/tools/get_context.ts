...
import type { StaticIndexSearchTool } from '@kbn/onechat-server/tools';
...
export const getContextToolDefinition = (): StaticIndexSearchTool => {
  return {
    ...
    description: `Fetch contextual knowledge base documents relevant to Automatic Troubleshooting.
