...
// 3. Evaluate the "group" field of all "insights" in the submission JSON. Do the values of "group" in the submission capture the overall essence of the .
...
// 7. Compare the submission json and the expected response json. Do over half of "eventIds" field in the "insights" in the submission .json overlap with the "eventIds" field in the expected responses .json? Respond with yes or no.
